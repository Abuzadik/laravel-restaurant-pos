                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="d-flex bd-highlight mb-3"> 
                                <h3 class="me-auto p-2 bd-highlight" > Create Table </h3>
                           ...
                           <hr>
                            ...
                            @endif
                            <form class="form-control" action="/admin/restaurant/table" method="POST">
                            @csrf
                                <div class="mb-3">
                                    <label for="exampleFormControlInput1" class="form-label">Table Name</label>
                                     <input type="text" class="form-control" id="exampleFormControlInput1" name="name" placeholder="Table Name / #No ......"> <br>
                                     <button type="submite" class="btn btn-primary"> Add Table </button>
                                </div>
                            </form>
                        </div>
                    </div>
