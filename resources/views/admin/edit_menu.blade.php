                    ...
                    <div class="row">
                        <div class="col-3">
                            ...
                            <a href="/admin/restaurant" class="list-group-item list-group-item-action "><i class="fa-solid fa-arrow-left-long  fa-lg"></i> <strong> Restaurant Dashboard </strong></a>
                                <a href="/admin/restaurant/category" class="list-group-item list-group-item-action"><strong> <i class="fa-solid fa-bars-staggered fa-lg"></i> Category </strong></a>
                        ...
                        <div class="d-flex bd-highlight mb-3"> 
                                <h3 class="me-auto p-2 bd-highlight" > Edit Food Menu </h3>
                           ...
                           <hr>
                            ...
                            @endif
                            <form class="form-control" action="/admin/restaurant/foodmenu/{{$foodmenus->id}}" method="POST" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                                <div class="mb-3">
                                    <label for="exampleFormControlInput1" class="form-label">Menu Name</label>
                                    <input type="text" class="form-control" value="{{$foodmenus->name}}" name="name" placeholder="Enter The Menu Name......"> <br>
                                    ...
                                    <input type="text" class="form-control"  name="detail" value="{{$foodmenus->detail}}" placeholder="Enter theDetail......"> <br>
                                    <label for="exampleFormControlInput1" class="form-label">Price</label>
                                    <input type="number" step="any" class="form-control"  name="price" value="{{$foodmenus->price}}" placeholder=" Enter the Price......"> <br>
                                    <label for="exampleFormControlInput1" class="form-label">Select Category</label>
                                    <select class="form-select" name="category_id"">
                                    <option selected>Select The Category</option>
                                        @foreach($categories as $category)
                                            <option value="{{$category->id}}" {{$foodmenus->category_id === $category->id ? 'selected':''}}>{{$category->name}}</option>
                                        @endforeach
                                    </select><br>
                                    <button type="submite" class="btn btn-primary"> Update Menu </button><br><br><br> <br>
                                </div><br><br><br> <br>
                            </form>
                        </div>
                    </div>
