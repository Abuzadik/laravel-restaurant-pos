                    ...
                    <div class="row">
                        <div class="col-3">
                            ...
                            <a href="/admin/restaurant" class="list-group-item list-group-item-action "><i class="fa-solid fa-arrow-left-long  fa-lg"></i> Restaurant Dashboard</a>
                                <a href="/admin/restaurant/category" class="list-group-item list-group-item-action active"><strong> <i class="fa-solid fa-bars-staggered fa-lg"></i> Category</strong></a>
                        ...
                        <div class="col-9">
                            <div class="d-flex bd-highlight mb-3"> 
                                <h3 class="me-auto p-2 bd-highlight" > Create Category </h3>
                           ...
                           <hr>
                            ...
                            @endif
                            <form class="form-control" action="/admin/restaurant/category" method="POST">
                            @csrf
                                <div class="mb-3">
                                    <label for="exampleFormControlInput1" class="form-label">Category Name</label>
                                     <input type="text" class="form-control" id="exampleFormControlInput1" name="name" placeholder="Category......"> <br>
                                     <button type="submite" class="btn btn-primary"> Add Catgeory </button>
                                </div>
                            </form>
                        </div>
                    </div>
