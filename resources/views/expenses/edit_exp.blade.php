                    ...
                    <div class="row">
                        ...
                        <div class="col-10">
                            <div class="d-flex bd-highlight mb-3"> 
                                <h3 class="me-auto p-2 bd-highlight" > Edit Expense </h3>
                           ...
                           <hr>
                            ...
                            @endif
                            <form class="form-control" action="/expenses/{{$expenses->id}}" method="POST">
                            @csrf
                            @method('PUT')
                                <div class="mb-3">
                                    <label for="exampleFormControlInput1" class="form-label">Expense Type</label>
                                     <input type="text" class="form-control" id="exampleFormControlInput1" name="expense_type" value="{{$expenses->expense_type}}" placeholder="Expense Type......"><br>
                                     <label for="exampleFormControlInput1" class="form-label">Expense Type</label>
                                     <input type="number" class="form-control" id="exampleFormControlInput1" name="amount" value="{{$expenses->amount}}" placeholder="Expense Amount......"><br>
                                    <label for="exampleFormControlInput1" class="form-label">Expense Detail</label>
                                     <textarea class="form-control" id="exampleFormControlInput1" name="detail" value="" placeholder="Expense Detail......"> {{$expenses->detail}} </textarea> <br>
